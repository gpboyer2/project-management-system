...
async function testProcessNodeTasksQuery() {
  try {
    console.log('🚀 测试 /process-node-tasks/query 接口...');
    ...
    console.log('✅ 接口返回值符合预期！');
    console.log('✅ /process-node-tasks/query 接口测试通过！');
