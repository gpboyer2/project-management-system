    ...
    steps: [
        {
            ...
            title: {
                "en-US": "Welcome to Node-View 4.1!",
                "ja": "Node-View 4.1 へようこそ!",
                "fr": "Bienvenue dans Node-View 4.1!"
            },
            description: {
        ...
        },
        {
            ...
            description: {
                "en-US": `<p>Stay up to date with notifications when there is a new Node-View version available, or updates to the nodes you have installed</p>`,
                "ja": `<p>新バージョンのNode-REDの提供や、インストールしたノードの更新があった時に、通知を受け取ることができます。</p>`,
                "fr": `<p>Désormais vous recevrez une notification lorsqu'une nouvelle version de Node-View ou une nouvelle version relative à un des noeuds que vous avez installés est disponible</p>`
            }
        },
        {
            title: {
        ...
        },
        {
            ...
            description: {
                "en-US": `<p>Flows exported from Node-View 4.1 now include information on what additional modules need to be installed.</p>
                ...
                `,
                "ja": `<p>Node-View 4.1から書き出したフローには、インストールが必要な追加モジュールの情報が含まれる様になりました。</p>
                <p>この情報を含むフローを読み込むと、エディタは不足しているモジュールを通知し、インストールを支援します。</p>
                `,
                "fr": `<p>Les flux exportés depuis Node-View 4.1 incluent désormais des informations sur les modules supplémentaires à installer.</p>
