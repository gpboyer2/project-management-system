    ...
    steps: [
        {
            ...
            title: {
                "en-US": "Welcome to Node-View 4.0!",
                "ja": "Node-View 4.0 へようこそ!",
                "fr": "Bienvenue dans Node-View 4.0!"
            },
            description: {
        ...
        },
        {
            ...
            description: {
                "en-US": `<p>This release includes the first small steps towards making Node-View easier
                ...
                "fr": `<p>Cette version inclut les premières étapes visant à rendre Node-View plus facile à utiliser
        ...
        },
        {
            ...
            description: {
                "en-US": `<p>When viewing changes made to a flow, Node-View now distinguishes between nodes that have had configuration
                ...
                "fr": `<p>Lors de l'affichage des modifications apportées à un flux, Node-View fait désormais la distinction entre les
