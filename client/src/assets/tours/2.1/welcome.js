    ...
    steps: [
        {
            ...
            title: {
                "en-US": "Welcome to Node-View 2.1!",
                "ja": "Node-View 2.1へようこそ!"
            },
            description: {
        ...
        },
        {
            ...
            description: {
                "en-US": "<p>First, as you've already found, we now have this tour of new features. We'll only show the tour the first time you open the editor for each new version of Node-View.</p>" +
