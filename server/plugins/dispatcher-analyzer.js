 ...
 * @returns {Object|null} 返回包含 field 和 offset 的对象，未找到返回 null
 */
 ...
 * @returns {Object} 返回分析结果，包含 found、field_name、offset、size 等字段
 */
 ...
 * @returns {Object} 返回dispatcher配置结果，包含 dispatch、messages、status、error_messages 字段
 * @example
 * const protocols = [
