 ...
 * @param {string} req.body.contextType - 上下文类型
 * @param {string} req.body.contextId - 上下文ID
 * @param {string} [req.body.contextName] - 上下文名称（可选）
 * @param {Object} req.body.options - 构建选项
 * @param {Object} res - Express 响应对象
 * @returns {void} 返回创建的构建任务信息
 */
 ...
 * @param {string} [req.query.contextType] - 上下文类型（可选）
 * @param {string} [req.query.contextId] - 上下文ID（可选）
 * @param {number} [req.query.limit] - 每页数量（可选）
 * @param {number} [req.query.offset] - 偏移量（可选）
 * @param {Object} res - Express 响应对象
 * @returns {void} 返回构建历史列表
 */
 ...
 * @param {string} req.params.taskId - 构建任务ID
 * @param {Object} res - Express 响应对象
 * @returns {void} 返回构建任务详情
 */
