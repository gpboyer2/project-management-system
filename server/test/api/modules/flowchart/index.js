...
describe('流程图模块', () => {
  ...
  /**
   * 测试根据体系节点ID获取通信节点列表 - 正常情况
   * 验证能够成功获取指定体系节点下的通信节点列表
   */
  ...
  /**
   * 测试根据体系节点ID加载流程图 - 不存在的流程图
   * 验证查询不存在的流程图时返回null或空对象
   */
  ...
  /**
   * 测试根据通信节点ID加载流程图 - 不存在的流程图
   * 验证通过通信节点ID查询不存在的流程图时返回null或空对象
   */
  ...
  /**
   * 测试根据体系节点ID获取通信节点列表 - 返回节点数据
   * 验证能够成功获取通信节点列表，并返回完整的节点数据
   */
