...
describe('通信节点模块', () => {
  ...
  /**
   * 测试根据层级节点ID获取通信节点列表 - 正常情况
   * 验证能够根据层级节点ID成功获取关联的通信节点列表
   */
